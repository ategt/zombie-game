...
function Player(){
    ...
    this.update = function() {
        ...
        // ctx.beginPath();
        // if (this.direction == 1) {
        //     ctx.arc(actingX, actingY + 1, 8, 0.9 * Math.PI, 1.7 * Math.PI);
        // } else {
        //     ctx.arc(actingX, actingY + 1, 8, 1.2 * Math.PI, 2 * Math.PI);
        // }
        ...
        // // Mask
        // if (this.direction == 1) {
        //     ctx.arc(actingX, actingY + 1, 8, 0.5 * Math.PI, 2 * Math.PI, true);
        // } else {
        //     ctx.arc(actingX, actingY + 1, 8, 1 * Math.PI, 0.5 * Math.PI, true);
        // }
        // ctx.fillStyle = 'red';
        // ctx.fill();
        ...
        // // better hat
        // ctx.beginPath();
        // ctx.arc(actingX, actingY + 1, 8, -0.2 * Math.PI, -0.8 * Math.PI, true);
        // ctx.fillStyle = 'red';
        // ctx.fill();
        ...
        // ctx.beginPath();
        // if (this.direction == 1) {
        //     ctx.arc(actingX, actingY + 1, 8, -0.2 * Math.PI, -0.9 * Math.PI, true);
        // } else {
        //     ctx.arc(actingX, actingY + 1, 8, -0.1 * Math.PI, -0.8 * Math.PI, true);
        // }
        // ctx.fillStyle = 'red';
        // ctx.fill();
        ...
        // // Mask
        // if (this.direction == 1) {
        //     ctx.arc(actingX, actingY + 1, 8, 1.2 * Math.PI, 0.5 * Math.PI);
        // } else {
        //     ctx.arc(actingX, actingY + 1, 8, 0.7 * Math.PI, 2 * Math.PI);
        // }
        // ctx.fillStyle = 'red';
        // ctx.fill();
...
function updateGameArea() {
    ...
    // myObjects.filter((item, index) => !(item.maxAge >= item.age) ).forEach((item, index) => {
    //     alert(`Age: ${item.age}, Max Age: ${item.maxAge}`);
    // })
